...
public class ApiDemo implements IConnectionHandler {
    ...
    private final AutomatedTradingPanel m_autoTradingPanel = new AutomatedTradingPanel();
    private final MarketValueAndPortfolioPanel m_testPanel = new MarketValueAndPortfolioPanel();
    ...
    private void run() {
        ...
        m_tabbedPanel.addTab("AutomatedTrading", m_autoTradingPanel);
        m_tabbedPanel.addTab("Test", m_testPanel);
